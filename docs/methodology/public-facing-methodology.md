...
The current inputs are ANN0830, ANN0831, and ANN0832 from the public [Rieseberg Lab `fastq-examples` repository](https://github.com/rieseberglab/fastq-examples).

> **Before publication:** Add verified biological provenance, study and licensing information, access date, and any applicable ethics context. Creator and license details for the sourced rose model and Unicorn Studio backgrounds also require completion.
